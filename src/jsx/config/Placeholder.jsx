export default {
	...
	readerStream: [
		...
		},
		{
			type: 'imgur',
			contributor: '06',
			content: '"Keep off the grass" sign in front of the war memorial, Central',
		...
		},
		{
			type: 'flickr',
			contributor: '01',
			content: 'Tomas Wiik has kindly shared his photos of the protest in Flickr. Have a look at them here:',
		...
		},
		{
			type: 'imgur',
			contributor: '02',
			content: '25-year-old activist Kenneth staged a one-man protest between 6pm and midnight. He had remained still, facing police at the Legislative Council Complex since the moment tear gas was first deployed.',
